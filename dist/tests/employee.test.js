...
describe("Employee Hierarchy", () => {
    ...
    it("should find an employee", () => {
        ...
        expect(employee === null || employee === void 0 ? void 0 : employee.name).toBe("evelina");
    });
